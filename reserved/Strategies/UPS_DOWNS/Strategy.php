...
class Strategy {
    ...
    public function buy($print = false) {
        ...
        // cases
        $rsi30      = false; //$this->utilityStrat->rsiBelow($this->currentRSI, 30);
        $priceDown  = $this->utilityStrat->calcPercentage($lastBuy, $lastClose) < -0.5;
    ...
    public function sell($print = false) {
        ...
        // cases
        $rsi70      = false; //$this->utilityStrat->rsiAbove($this->currentRSI, 70);
        $priceUp    = $this->utilityStrat->calcPercentage($lastBuy, $lastClose) > 0.5;
